...
- **[commands/](commands/)** - Cursor slash commands
...
Slash commands live in [agents/commands/](commands/) and are shared via `.cursor/commands` (generated by `pnpm setup:agent-links`).
